...
export declare function useMap(): {
    [id: string]: _MapRef<MapboxMap>;
    current?: _MapRef<MapboxMap>;
};
export declare type MapProps = _MapProps<MapboxOptions, MapboxStyle, MapCallbacks, MapboxMap>;
...
export declare const Map: React.ForwardRefExoticComponent<{
    ...
    mapStyle?: string | MapboxStyle | import("./types/common").ImmutableLike<MapboxStyle>;
